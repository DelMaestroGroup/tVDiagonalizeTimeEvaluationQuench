...
Cycles, CycleSize, NumOfCycles, CReflection =Translational_Reflection_Symmetry_Cycles(basis)
...
for q =0: basis.K-1
   ...
   if  q*(q-basis.K/2)==0
      for R in [1,-1]
         #Create the Hamiltonian
         Hq,HqBasis,HqRank = Block_Diagonal_Hamiltonian_Reflection(basis, Cycles, CycleSize, NumOfCycles, CReflection, c[:t],V,q,R)
         EigenEnergies_q,VV = eig(Hq)
         for i_HqRank =1: HqRank
             for j_HqRank =1: HqRank
                 CycleSizeij = CReflection[HqBasis[j_HqRank]] ? 2*CycleSize[HqBasis[j_HqRank]] :  CycleSize[HqBasis[j_HqRank]]
                 ...
                 if CReflection[HqBasis[j_HqRank]]
                     for i_Translation =1: CycleSize[HqBasis[j_HqRank]+1]
                         EigenVector[Cycles[HqBasis[j_HqRank]+1,i_Translation]]+=R*exp_q[i_Translation]* VV[j_HqRank, i_HqRank]/sqrt(CycleSizeij)
                     end
                 end
             end
         ...
         for i_HqRank =1: HqRank
             for j_HqRank =1: HqRank
                  CycleSizeij = CycleSize[HqBasis[j_HqRank]]
                 for i_Translation =1: CycleSize[HqBasis[j_HqRank]]
                     EigenVector[Cycles[HqBasis[j_HqRank],i_Translation]]+=exp_q[i_Translation]* VV[j_HqRank, i_HqRank]/sqrt(CycleSizeij)
                 end
             end
